...
EFFORT_ESTIMATION_TEMPLATE = {
    ...
    "Application Customization": {
        "total": 8,
        "tasks": {
            "Data Forms": 4,  # Test data: details=5
            "Dashboards": 4  # Test data: in_scope=NO
        }
    },
    ...
    "Historical Data": {
        "total": 60,
        "tasks": {
            "Historical Data Validation": 0,  # Calculated field in Excel
            "Data Validation for Account Alt Hierarchies": 20,  # Test data: details=0
            "Data Validation for Entity Alt Hierarchies": 20,  # Test data: details=0
            "Historical Journal Conversion": 20  # Test data: details=0
        }
    },
    ...
    "Reporting": {
        ...
        "tasks": {
            ...
            "Intercompany Reports": 8,  # Test data: details=1
